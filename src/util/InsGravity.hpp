...
/// @brief Calculates the local gravity vector at the WGS84 reference ellipsoid using gravity
...
/// @brief Calculates a gravity vector that contains the centrifugal acceleration
...
/// @param[in] gravityMagnitude Magnitude of gravity according to the respective gravity Model
/// @return gravity vector in [m/s^2]
///
/// @note See Jekeli (2001) - Inertial Navigation Systems with Geodetic Applications (Chapter 4.3 - eq. 4.89)
