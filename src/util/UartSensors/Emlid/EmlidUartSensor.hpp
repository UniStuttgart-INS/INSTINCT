...
class EmlidUartSensor
{
  public:
    ...
    static constexpr uint8_t BinarySyncChar1 = 0x82; ///< R - First sync character which begins a new binary message
    static constexpr uint8_t BinarySyncChar2 = 0x45; ///< E - Second sync character which begins a new binary message
