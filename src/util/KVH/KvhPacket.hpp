/**
 * @file KvhPacket.hpp
 * @brief Kvh Packet containing binary data
...
class KvhPacket
{
  public:
    ...
    KvhPacket(unsigned char const* packet, size_t length);
...
#define I1(p) (*((signed char*)(p)))
    static uint16_t U2(const unsigned char* p)
    {
        uint16_t u = 0;
        memcpy(&u, p, 2);
        return u;
    ...
    static double I8(const unsigned char* p)
    {
