...
struct BinaryOutputRegister
{
    ...
    BinaryOutputRegister() : asyncMode(protocol::uart::ASYNCMODE_NONE),
                             rateDivisor(0),
    ...
    BinaryOutputRegister(
        ...
        protocol::uart::GpsGroup gps2FieldIn) : asyncMode(asyncModeIn),
    ...
    BinaryOutputRegister(
        ...
        uint16_t insFieldIn,
        uint16_t gps2FieldIn) : asyncMode(static_cast<protocol::uart::AsyncMode>(asyncModeIn)),
                                rateDivisor(rateDivisorIn),
...
struct QuaternionMagneticAccelerationAndAngularRatesRegister
{
    ...
    QuaternionMagneticAccelerationAndAngularRatesRegister() = default;
    ...
    QuaternionMagneticAccelerationAndAngularRatesRegister(
        ...
        vn::math::vec3f gyroIn) : quat(quatIn),
                                  mag(magIn),
                                  accel(accelIn),
                                  gyro(gyroIn)
    {}
...
struct MagneticAccelerationAndAngularRatesRegister
{
    ...
    MagneticAccelerationAndAngularRatesRegister() = default;
    ...
    MagneticAccelerationAndAngularRatesRegister(
        vn::math::vec3f magIn,
        vn::math::vec3f accelIn,
        vn::math::vec3f gyroIn) : mag(magIn),
                                  accel(accelIn),
                                  gyro(gyroIn)
    {}
};
...
struct MagneticAndGravityReferenceVectorsRegister
{
    ...
    MagneticAndGravityReferenceVectorsRegister() = default;
    ...
    MagneticAndGravityReferenceVectorsRegister(
        ...
        vn::math::vec3f accRefIn) : magRef(magRefIn),
                                    accRef(accRefIn)
    {}
};
...
struct FilterMeasurementsVarianceParametersRegister
{
    ...
    FilterMeasurementsVarianceParametersRegister() = default;
    ...
    FilterMeasurementsVarianceParametersRegister(
        ...
        vn::math::vec3f accelerationVarianceIn) : angularWalkVariance(angularWalkVarianceIn),
...
struct MagnetometerCompensationRegister
{
    ...
    MagnetometerCompensationRegister() = default;
...
struct FilterActiveTuningParametersRegister
{
    ...
    FilterActiveTuningParametersRegister() = default;
    ...
    FilterActiveTuningParametersRegister(
        ...
        float accelerationDisturbanceMemoryIn) : magneticDisturbanceGain(magneticDisturbanceGainIn),
...
struct AccelerationCompensationRegister
{
    ...
    AccelerationCompensationRegister() = default;
...
struct YawPitchRollMagneticAccelerationAndAngularRatesRegister
{
    ...
    YawPitchRollMagneticAccelerationAndAngularRatesRegister() = default;
    ...
    YawPitchRollMagneticAccelerationAndAngularRatesRegister(
        ...
        vn::math::vec3f magIn,
        vn::math::vec3f accelIn,
        vn::math::vec3f gyroIn) : yawPitchRoll(yawPitchRollIn),
                                  mag(magIn),
                                  accel(accelIn),
                                  gyro(gyroIn)
    {}
...
struct CommunicationProtocolControlRegister
{
    ...
    CommunicationProtocolControlRegister() = default;
    ...
    CommunicationProtocolControlRegister(
        ...
        protocol::uart::ErrorMode errorModeIn) : serialCount(serialCountIn),
...
struct SynchronizationControlRegister
{
    ...
    SynchronizationControlRegister() = default;
    ...
    SynchronizationControlRegister(
        ...
        uint32_t syncOutPulseWidthIn) : syncInMode(syncInModeIn),
...
struct SynchronizationStatusRegister
{
    ...
    SynchronizationStatusRegister() = default;
    ...
    SynchronizationStatusRegister(
        ...
        uint32_t syncOutCountIn) : syncInCount(syncInCountIn),
...
struct FilterBasicControlRegister
{
    ...
    FilterBasicControlRegister() = default;
    ...
    FilterBasicControlRegister(
        ...
        vn::math::vec3f gyroLimitIn) : magMode(magModeIn),
...
struct VpeBasicControlRegister
{
    ...
    VpeBasicControlRegister() = default;
    ...
    VpeBasicControlRegister(
        ...
        protocol::uart::VpeMode tuningModeIn) : enable(enableIn),
...
struct HeaveConfigurationRegister
{
    ...
    HeaveConfigurationRegister() = default;
    ...
    HeaveConfigurationRegister(
        ...
        float heaveRateCutoffFreqIn) : initialWavePeriod(initialWavePeriodIn),
...
struct VpeMagnetometerBasicTuningRegister
{
    ...
    VpeMagnetometerBasicTuningRegister() = default;
    ...
    VpeMagnetometerBasicTuningRegister(
        ...
        vn::math::vec3f adaptiveFilteringIn) : baseTuning(baseTuningIn),
...
struct VpeMagnetometerAdvancedTuningRegister
{
    ...
    VpeMagnetometerAdvancedTuningRegister() = default;
...
struct VpeAccelerometerBasicTuningRegister
{
    ...
    VpeAccelerometerBasicTuningRegister() = default;
...
struct VpeAccelerometerAdvancedTuningRegister
{
    ...
    VpeAccelerometerAdvancedTuningRegister() = default;
...
struct VpeGyroBasicTuningRegister
{
    ...
    VpeGyroBasicTuningRegister() = default;
    ...
    VpeGyroBasicTuningRegister(
        ...
        vn::math::vec3f baseTuningIn,
        vn::math::vec3f adaptiveTuningIn) : angularWalkVariance(angularWalkVarianceIn),
...
struct MagnetometerCalibrationControlRegister
{
    ...
    MagnetometerCalibrationControlRegister() = default;
    ...
    MagnetometerCalibrationControlRegister(
        ...
        uint8_t convergeRateIn) : hsiMode(hsiModeIn),
...
struct CalculatedMagnetometerCalibrationRegister
{
    ...
    CalculatedMagnetometerCalibrationRegister() = default;
...
struct VelocityCompensationControlRegister
{
    ...
    VelocityCompensationControlRegister() = default;
    ...
    VelocityCompensationControlRegister(
        ...
        float rateTuningIn) : mode(modeIn),
...
struct VelocityCompensationStatusRegister
{
    ...
    VelocityCompensationStatusRegister() = default;
...
struct ImuMeasurementsRegister
{
    ...
    ImuMeasurementsRegister() = default;
...
struct GpsConfigurationRegister
{
    ...
    GpsConfigurationRegister() : rate(protocol::uart::GPSRATE_5HZ),
    ...
    GpsConfigurationRegister(
        ...
        protocol::uart::PpsSource ppsSourceIn) : mode(modeIn),
    ...
    GpsConfigurationRegister(
        ...
        protocol::uart::AntPower antPowIn) : mode(modeIn),
                                             ppsSource(ppsSourceIn),
                                             rate(rateIn),
                                             antPow(antPowIn)
    {}
...
struct GpsSolutionLlaRegister
{
    ...
    GpsSolutionLlaRegister() = default;
...
struct GpsSolutionEcefRegister
{
    ...
    GpsSolutionEcefRegister() = default;
...
struct InsSolutionLlaRegister
{
    ...
    InsSolutionLlaRegister() = default;
    ...
    InsSolutionLlaRegister(
        ...
        float velUncertaintyIn) : time(timeIn),
                                  week(weekIn),
                                  status(statusIn),
...
struct InsSolutionEcefRegister
{
    ...
    InsSolutionEcefRegister() = default;
...
struct InsBasicConfigurationRegisterVn200
{
    ...
    InsBasicConfigurationRegisterVn200() = default;
    ...
    InsBasicConfigurationRegisterVn200(
        ...
        bool ahrsAidingIn) : scenario(scenarioIn),
...
struct InsBasicConfigurationRegisterVn300
{
    ...
    InsBasicConfigurationRegisterVn300() = default;
    ...
    InsBasicConfigurationRegisterVn300(
        protocol::uart::Scenario scenarioIn,
        bool ahrsAidingIn,
        bool estBaselineIn) : scenario(scenarioIn),
                              ahrsAiding(ahrsAidingIn),
...
struct InsAdvancedConfigurationRegister
{
    ...
    InsAdvancedConfigurationRegister() = default;
    ...
    InsAdvancedConfigurationRegister(
        ...
        float minVelUncertaintyIn) : useMag(useMagIn),
                                     usePres(usePresIn),
                                     posAtt(posAttIn),
                                     velAtt(velAttIn),
                                     velBias(velBiasIn),
...
struct InsStateLlaRegister
{
    ...
    InsStateLlaRegister(
        ...
        vn::math::vec3f velocityIn,
        vn::math::vec3f accelIn,
        vn::math::vec3f angularRateIn) : yawPitchRoll(yawPitchRollIn),
                                         position(positionIn),
                                         velocity(velocityIn),
                                         accel(accelIn),
...
struct StartupFilterBiasEstimateRegister
{
    ...
    StartupFilterBiasEstimateRegister() = default;
    ...
    StartupFilterBiasEstimateRegister(
        ...
        float pressureBiasIn) : gyroBias(gyroBiasIn),
...
struct DeltaThetaAndDeltaVelocityRegister
{
    ...
    DeltaThetaAndDeltaVelocityRegister() = default;
    ...
    DeltaThetaAndDeltaVelocityRegister(
        ...
        vn::math::vec3f deltaVelocityIn) : deltaTime(deltaTimeIn),
...
struct DeltaThetaAndDeltaVelocityConfigurationRegister
{
    ...
    DeltaThetaAndDeltaVelocityConfigurationRegister() : earthRateCorrection(protocol::uart::EARTHRATECORR_NONE)
    {}
    ...
    DeltaThetaAndDeltaVelocityConfigurationRegister(
        ...
        protocol::uart::AccCompensationMode accelCompensationIn) : integrationFrame(integrationFrameIn),
    ...
    /// \param[in] gyroCompensationIn Value to initialize the gyroCompensation field with.
    /// \param[in] accelCompensationIn Value to initialize the accelCompensation field with.
    /// \param[in] earthRateCorrectionIn Value to initialize the earthRateCorrection field with.
    DeltaThetaAndDeltaVelocityConfigurationRegister(
        protocol::uart::IntegrationFrame integrationFrameIn,
        protocol::uart::CompensationMode gyroCompensationIn,
        protocol::uart::AccCompensationMode accelCompensationIn,
        protocol::uart::EarthRateCorrection earthRateCorrectionIn) : integrationFrame(integrationFrameIn),
                                                                     gyroCompensation(gyroCompensationIn),
                                                                     accelCompensation(accelCompensationIn),
...
struct ReferenceVectorConfigurationRegister
{
    ...
    ReferenceVectorConfigurationRegister() = default;
    ...
    ReferenceVectorConfigurationRegister(
        ...
        float yearIn,
        vn::math::vec3d positionIn) : useMagModel(useMagModelIn),
...
struct GyroCompensationRegister
{
    ...
    GyroCompensationRegister() = default;
...
struct ImuFilteringConfigurationRegister
{
    ...
    ImuFilteringConfigurationRegister() = default;
    ...
    ImuFilteringConfigurationRegister(
        ...
        protocol::uart::FilterMode presFilterModeIn) : magWindowSize(magWindowSizeIn),
...
struct GpsCompassBaselineRegister
{
    ...
    GpsCompassBaselineRegister() = default;
    ...
    GpsCompassBaselineRegister(
        ...
        vn::math::vec3f uncertaintyIn) : position(positionIn),
...
struct GpsCompassEstimatedBaselineRegister
{
    ...
    GpsCompassEstimatedBaselineRegister() = default;
    ...
    GpsCompassEstimatedBaselineRegister(
        ...
        uint16_t numMeasIn,
        vn::math::vec3f positionIn,
        vn::math::vec3f uncertaintyIn) : estBaselineUsed(estBaselineUsedIn),
                                         numMeas(numMeasIn),
                                         position(positionIn),
                                         uncertainty(uncertaintyIn)
    {}
...
struct ImuRateConfigurationRegister
{
    ...
    ImuRateConfigurationRegister() = default;
    ...
    ImuRateConfigurationRegister(
        ...
        float filterMinRateIn) : imuRate(imuRateIn),
...
struct YawPitchRollTrueBodyAccelerationAndAngularRatesRegister
{
    ...
    YawPitchRollTrueBodyAccelerationAndAngularRatesRegister() = default;
...
struct YawPitchRollTrueInertialAccelerationAndAngularRatesRegister
{
    ...
    YawPitchRollTrueInertialAccelerationAndAngularRatesRegister() = default;
