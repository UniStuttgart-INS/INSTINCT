...
enum ErbMessageID
{
    ERB_Message_IDNONE = 0x00, ///< No Message Class specified
    ERB_Message_VER = 0x01,  ///< Version of protocol
    ERB_Message_POS = 0x02,  ///< Geodetic position solution
    ERB_Message_STAT = 0x03,  ///< Receiver navigation status
    ERB_Message_DPOS = 0x04,  ///< Dilution of precision
    ERB_Message_VEL = 0x05,  ///< Velocity solution in NED
    ERB_Message_SVI = 0x06,  ///< Space vehicle information
    ERB_Message_RTK = 0x07,  ///< RTK information
};
...
struct ErbNavPosllh
{
    ...
    double hMSL = 0;   ///< Height above mean sea level [m]
 ...
 * @retval ErbMessageID The ERB ID
 */
[[nodiscard]] uint8_t getMsgIdFromString(const std::string_view& idName);
