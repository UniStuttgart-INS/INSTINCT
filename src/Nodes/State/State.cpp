...
void NAV::State::updateState(std::shared_ptr<NodeData> state)
{
    // Process the data here
    currentState = *std::static_pointer_cast<StateData>(state);
}

void NAV::State::initAttitude(std::shared_ptr<NodeData> nodeData)
{
...
void NAV::State::initPositionVelocity(std::shared_ptr<NodeData> nodeData)
{
