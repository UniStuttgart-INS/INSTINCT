...
class EmlidFile final : public FileReader, public Gnss
{
  public:
    ...
    EmlidFile() = default;                           ///< Default Constructor
    ~EmlidFile() final;                              ///< Destructor
    EmlidFile(const EmlidFile&) = delete;            ///< Copy constructor
    EmlidFile(EmlidFile&&) = delete;                 ///< Move constructor
    EmlidFile& operator=(const EmlidFile&) = delete; ///< Copy assignment operator
    EmlidFile& operator=(EmlidFile&&) = delete;      ///< Move assignment operator
