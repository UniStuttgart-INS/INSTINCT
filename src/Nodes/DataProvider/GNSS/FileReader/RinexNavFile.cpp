...
void RinexNavFile::readOrbits()
{
    ...
    try
    {
        while (getline(line) && !eof())
        {
            ...
            auto satNumStr = line.substr(1 - offset, 2);
            ...
            if (satSys == GPS || satSys == GAL || satSys == QZSS || satSys == BDS) // NOLINT(misc-redundant-expression) // bugged warning
            {
                ...
                a[0] = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase));
                // SV clock drift [sec/sec]
                a[1] = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase));
                // SV clock drift rate [sec/sec^2]
                a[2] = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                auto IODE_IODnav_AODE_IODEC = static_cast<size_t>(std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase)));
                // Crs (meters)
                double Crs = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase));
                // Delta n (radians/sec)
                double delta_n = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase));
                // M0 (radians)
                double M_0 = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                // Cuc (radians)
                double Cuc = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase));
                // e Eccentricity
                double e = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase));
                // Cus (radians)
                double Cus = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase));
                // sqrt(A) (sqrt(m))
                double sqrt_A = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                double toeSec = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase));
                // Cic (radians)
                double Cic = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase));
                // OMEGA0 (radians)
                double Omega_0 = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase));
                // Cis (radians)
                double Cis = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                // i0 (radians)
                double i_0 = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase));
                // Crc (meters)
                double Crc = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase));
                // omega (radians)
                double omega = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase));
                // OMEGA DOT (radians/sec)
                double Omega_dot = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                // IDOT (radians/sec)
                double i_dot = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                // BDS/IRNSS: Spare
                auto codesOnL2Channel_dataSources = static_cast<uint16_t>(str::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase), 0));

                // GPS Week # (to go with TOE) Continuous number, not mod(1024)!
                auto gpsWeek = static_cast<int32_t>(str::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase), epoch.toGPSweekTow().gpsWeek));
                ...
                // GAL/BDS/IRNSS:  Spare
                bool L2PdataFlag = static_cast<bool>(str::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase), 0.0));
                ...
                //        nominal values, N = 0-6: use 2(1+N/2) (round to one decimal place i.e. 2.8, 5.7 and 11.3) ,
                //        N= 7-15:use 2 (N-2), 8192 specifies use at own risk
                double signalAccuracy = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                auto svHealth = static_cast<uint16_t>(std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase)));
                // GPS:  TGD (seconds)
                ...
                double tgd_bgd5a_TGD1 = str::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase), 0.0);

                // GPS/QZSS: IODC Issue of Data, Clock
                // GAL:      BGD E5b/E1 (seconds)
                // BDS:      TGD2 B2/B3 (seconds)
                // IRNSS:    Blank
                double IODC_bgd5b_TGD2 = str::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase), 0.0);
                ...
                [[maybe_unused]] auto transmissionTime = str::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase), 0.0);
                ...
                auto fitInterval_AODC = str::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase), 0.0);
                // Spare
                // std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase));
                // Spare
                // std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
            ...
            else if (satSys == GLO || satSys == SBAS) // NOLINT(misc-redundant-expression) // bugged warning
            {
                ...
                pos.x() = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // velocity X dot (km/sec)
                vel.x() = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // X acceleration (km/sec2)
                accelLuniSolar.x() = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                ...
                [[maybe_unused]] auto health = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                pos.y() = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // velocity Y dot (km/sec)
                vel.y() = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // Y acceleration (km/sec2)
                accelLuniSolar.y() = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // GLO:  frequency number(-7...+13) (-7...+6 ICD 5.1)
                // SBAS: Accuracy code (URA, meters)
                double frequencyNumber_accuracyCode = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
                ...
                pos.z() = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // velocity Z dot (km/sec)
                vel.z() = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // Z acceleration (km/sec2)
                accelLuniSolar.z() = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase)) * 1e3;
                // GLO:  Age of oper. information (days) (E)
                // SBAS: IODN (Issue of Data Navigation, DO229, 8 first bits after Message Type if MT9)
                [[maybe_unused]] auto ageOfOperation_IODN = str::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase), 0.0);
                ...
                if (satSys == GLO && _version >= 3.05)
                {
                    ...
                    // status flags (FLOAT converted to INTEGER)
                    ...
                    [[maybe_unused]] double statusFlags = std::stod(str::replaceAll_copy(line.substr(4 - offset, 19), "d", "e", str::IgnoreCase));
                    // L1/L2 group delay difference Δτ [sec]
                    [[maybe_unused]] double L1L2groupDelayDifference = std::stod(str::replaceAll_copy(line.substr(23 - offset, 19), "d", "e", str::IgnoreCase));
                    // URAI raw accuracy index F_T (GLO-M/K only)
                    [[maybe_unused]] double URAI = std::stod(str::replaceAll_copy(line.substr(42 - offset, 19), "d", "e", str::IgnoreCase));
                    // health flags (FLOAT converted to INTEGER)
                    ...
                    [[maybe_unused]] double healthFlags = std::stod(str::replaceAll_copy(line.substr(61 - offset, 19), "d", "e", str::IgnoreCase));
