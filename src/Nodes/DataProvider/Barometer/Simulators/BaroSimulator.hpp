...
/// @file BaroSimulator.hpp
/// @brief Barometer observation simulator
...
class BaroSimulator : public Node
{
  public:
  ...
  private:
    constexpr static size_t OUTPUT_PORT_INDEX_BAROPRESSURE = 0; ///< @brief Flow
...
constexpr const char* to_string(NAV::BaroSimulator::GravityInput value)
{
    switch (value)
    {
    case NAV::BaroSimulator::GravityInput::Manual:
        return "Manual";
    case NAV::BaroSimulator::GravityInput::Position:
        return "Position";
    case NAV::BaroSimulator::GravityInput::COUNT:
        return "";
    }
    return "";
}
