...
/// @file EnumComboWithAbbreviation.hpp
...
/// @brief Combo representing an enumeration and use abbreviations to display in the preview
...
{
    bool clicked = false;
    if (ImGui::BeginCombo(label, NAV::to_string_short(enumeration)))
    {
