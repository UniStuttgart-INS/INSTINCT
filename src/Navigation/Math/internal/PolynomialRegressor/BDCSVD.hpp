...
/// @file BDCSVD.hpp
/// @brief Bidiagonal Divide and Conquer SVD Curve Fit
...
/// @brief Bidiagonal Divide and Conquer SVD Curve Fitting
...
class BDCSVD
{
  public:
    ...
    [[nodiscard]] static Eigen::VectorX<Scalar> calcCoefficients(const Eigen::MatrixBase<DerivedX>& x, const Eigen::MatrixBase<DerivedY>& y, size_t polynomialDegree = 2)
    {
        ...
        ;
        return Eigen::BDCSVD<Eigen::MatrixXd>(H, Eigen::ComputeThinU | Eigen::ComputeThinV).solve(y);
    }
};
