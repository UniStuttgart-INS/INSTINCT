...
Orbit::Pos GalileoEphemeris::calcSatellitePos(const InsTime& transTime) const
{
    ...
    const auto mu = InsConst::GPS::MU; // TODO: Replace with GALILEO constant after exchanging the test file
    // Earth angular velocity [rad/s] (WGS 84 value of the earth's rotation rate)
    const auto Omega_e_dot = InsConst::GPS::omega_ie; // TODO: Replace with GALILEO constant after exchanging the test file
...
Orbit::PosVel GalileoEphemeris::calcSatellitePosVel(const InsTime& transTime) const
{
    LOG_DATA("Calc Sat Position at transmit time {}", transTime.toGPSweekTow());
    // Earth gravitational constant [m³/s²] (WGS 84 value of the earth's gravitational constant for GPS user)
    const auto mu = InsConst::GPS::MU; // TODO: Replace with GALILEO constant after exchanging the test file
...
Orbit::PosVelAccel GalileoEphemeris::calcSatellitePosVelAccel(const InsTime& transTime) const
{
    LOG_DATA("Calc Sat Position at transmit time {}", transTime.toGPSweekTow());
    // Earth gravitational constant [m³/s²] (WGS 84 value of the earth's gravitational constant for GPS user)
    const auto mu = InsConst::GPS::MU; // TODO: Replace with GALILEO constant after exchanging the test file
