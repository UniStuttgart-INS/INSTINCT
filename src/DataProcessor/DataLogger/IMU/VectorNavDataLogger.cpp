...
NAV::NavStatus NAV::VectorNavDataLogger::writeObservation(std::shared_ptr<void> obs, std::shared_ptr<void> userData)
{
    auto vnObs = std::static_pointer_cast<VectorNavObs>(obs);
