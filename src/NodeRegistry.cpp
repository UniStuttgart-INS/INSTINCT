...
#include "Nodes/DataProvider/IMU/FileReader/SpirentSimSENSORFile.hpp"
...
#include "Nodes/DataProvider/Barometer/Simulators/BaroSimulator.hpp"
// Plotting
...
void NAV::NodeRegistry::RegisterNodeTypes()
{
    ...
    registerNodeType<SpirentSimSENSORFile>();
    ...
    registerNodeType<BaroSimulator>();
    // Experimental
