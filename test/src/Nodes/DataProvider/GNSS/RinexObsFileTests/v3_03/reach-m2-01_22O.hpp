...
const std::vector<GnssObs> gnssObs_reach_m2_01_22O = {
    { /* .insTime = */ InsTime{ 2022, 11, 2, 16, 39, 59.6920000, GPST },
      ...
      /* ._satData = */ std::vector<GnssObs::SatelliteData>{
          { .satId = SatId(GPS, 1), .frequencies = G01 | G02 },
          { .satId = SatId(GPS, 13), .frequencies = G01 },
          { .satId = SatId(GLO, 1), .frequencies = R01 | R02 },
          { .satId = SatId(GLO, 10), .frequencies = R01 },
          { .satId = SatId(GLO, 13), .frequencies = R01 | R02 },
          { .satId = SatId(GAL, 3), .frequencies = E01 | E07 },
          { .satId = SatId(GAL, 5), .frequencies = E01 },
          { .satId = SatId(BDS, 7), .frequencies = B07 },
          { .satId = SatId(BDS, 10), .frequencies = B02 | B07 },
          { .satId = SatId(BDS, 23), .frequencies = B02 },
